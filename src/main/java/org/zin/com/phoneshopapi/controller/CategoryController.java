...
public class CategoryController {
    ...
    public ResponseEntity<ApiResponse<PageResponse<CategoryResponse>>> getAll(
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(ApiResponse.success("Category Retrieve Successfully", categoryService.getAll(page, limit, sort, params)));
    }
    ...
    public ResponseEntity<ApiResponse<CategoryResponse>> create(@RequestBody  @Valid CategoryRequest categoryRequest){
        return ResponseEntity.status(HttpStatus.OK).body(ApiResponse.success("Category create Successfully", categoryService.save(categoryRequest)));
    }
